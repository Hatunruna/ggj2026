...
#ifndef GLT_KICKOFF_WELCOME_SCENE_H
#define GLT_KICKOFF_WELCOME_SCENE_H
...
namespace glt {
  ...
  class KickoffWelcomeScene : public gf::Scene {
  public:
    KickoffWelcomeScene(Game* game, const KickoffResources& resources);
...
#endif // GLT_KICKOFF_WELCOME_SCENE_H
